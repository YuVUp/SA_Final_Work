...
#### 6.2.3.6
**Вариант использования: UC.01.07 «Получить талон с номером»**
...
EX-1: Неисправность принтера - Система показывает сообщение «Талон не может быть напечатан. Сообщите номер заказа оператору: XXX». Система уведомляет менеджера о неисправности.

EX-2: Сбой при передаче заказа на производство - Система показывает сообщение «Ошибка обработки заказа. Обратитесь к менеджеру.» и изменяет статус заказа на «Ошибка».

### 6.2.3.7

**Вариант использования: UC.01.05 «Добавить позиции в корзину» (Детализация в контексте UC.01.01)**
