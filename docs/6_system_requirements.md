...
graph TB
    %% DOR блок
    DOR[Definition of Ready (DOR)<br/>- User Story сформулирована<br/>- Критерии приемки определены<br/>- Дизайн-макеты готовы<br/>- Бизнес-логика документирована<br/>- Зависимости идентифицированы<br/>- Технические требования]
    ...
    %% Общий DOD
    DOD[Definition of Done (DOD)<br/>- Код написан по стандартам<br/>- Проведен code review<br/>- Все тесты пройдены<br/>- Локализация выполнена<br/>- Документация обновлена<br/>- Регрессионное тестирование]
